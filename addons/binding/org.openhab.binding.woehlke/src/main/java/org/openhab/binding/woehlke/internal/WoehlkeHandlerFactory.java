...
/**
 * The {@link WoehlkeHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
 * @author Lukas Smirek - Initial contribution
 */
@Component(service = ThingHandlerFactory.class, immediate = true, configurationPid = "binding.woehlke")
@NonNullByDefault
